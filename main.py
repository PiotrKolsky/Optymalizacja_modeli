...
if __name__ == '__main__':
    ...
    sample_start = randint(0, len(data[0])-sample_len)
    sample = data[0].iloc[sample_start:(sample_start+sample_len)].fillna(-999, inplace=False)
    ...
    model_opt = prediction.train_model(method_choosen(prediction.prepare_model()), x_train, x_test, y_train, y_test, cat_features_index)
    ...
    prediction.cross_validation(model_opt, x, y, cat_features_index)
