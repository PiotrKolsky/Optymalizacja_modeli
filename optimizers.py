...
class Optimalization():
    ...
    def prepare_randomized_opt(self, model):
        ...
        param_distributions={'learning_rate': np.power(10, np.linspace(-2, -0.25, 10)),
                             ...
                             'min_child_samples': np.arange(3, 7)
                             }
    ...
    def prepare_hyperband_opt(self, model):
        ...
        param_distributions.add_hyperparameter(CSH.UniformIntegerHyperparameter('depth', 2, 15))
        param_distributions.add_hyperparameter(CSH.UniformIntegerHyperparameter('min_child_samples', 3, 6))
        ...
        optimizer = HpBandSterSearchCV(model,
                                       ...
                                       n_iter=50, 
                                       verbose=0,
                                       optimizer = 'hyperband' #hyperband bohb
                                       )
        if optimizer:
